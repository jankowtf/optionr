...
test_that("rmAnywhereOption/strict", {
  ...
  expect_error(rmAnywhereOption(id = "a", strict = TRUE))
  
  expect_false(rmAnywhereOption(id = "a/b/c"))
  expect_error(rmAnywhereOption(id = "a/b/c", strict = TRUE))
  
  expect_false(rmAnywhereOption(id = character()))
  expect_error(rmAnywhereOption(id = character(), strict = TRUE))
